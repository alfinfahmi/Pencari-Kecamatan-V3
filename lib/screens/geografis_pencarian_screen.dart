...
/// Layar "Data Geografis" -- pencarian kecamatan/kabupaten + tab
/// Favorit/Riwayat. Sebelumnya ini adalah tampilan UTAMA menu Home;
/// dipindah ke sini supaya Home bisa menampilkan jam & kalender sebagai
/// tampilan utama yang lebih ringkas.
class GeografisPencarianScreen extends StatefulWidget {
  const GeografisPencarianScreen({super.key});

  @override
  State<GeografisPencarianScreen> createState() => _GeografisPencarianScreenState();
}

class _GeografisPencarianScreenState extends State<GeografisPencarianScreen> {
